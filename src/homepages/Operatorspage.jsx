...
import { data } from './OperatorData.jsx'
...
function Operators(props) {
     ...
     const handleFilterChange = (selectedSubclass) => {
          ...
          document.getElementById(selectedSubclass).classList.toggle('active-filter')
     };
     ...
     const handleBatchFilter = (subclassList) => {
          ...
          subclassList.forEach(subclass => {
               ...
               document.getElementById(subclass).classList.remove('active-filter')
          });
          ...
          if (trueCounter !== subclassList.length) {
               ...
               subclassList.forEach(subclass => {
                    ...
                    document.getElementById(subclass).classList.add('active-filter')
               });
          }
     ...
     const filterStars = (starvalue, listid) =>{
          if (starFilter.includes(starvalue)){
               ...
               document.getElementById(listid).classList.remove('active-filter')
          }
          else{
               setStarFilter([...starFilter, starvalue])
               document.getElementById(listid).classList.add('active-filter')
          }
     }
     ...
     const filterLimited = (listid) => {
          ...
          document.getElementById(listid).classList.toggle('active-filter')
     }
     ...
     return (
          <div style={displayer} className='operator-container'>
               <div className='filter-container'>
                    <ul className='extra-filter-container'>
                         ...
                         <li id='limitedFilter' onClick={()=>filterLimited('limitedFilter')}>Limited</li>
                    </ul>
               ...
               <hr/>
               <div style={gridLayout} className='cards-container'>
